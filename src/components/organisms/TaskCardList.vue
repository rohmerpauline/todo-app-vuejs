...
const tasks = [
  ...
  { id: 6, title: 'Add filtering options for tasks on the ToDoList page.', deadline: '2024-03-15' },
  {
    id: 7,
  ...
  { id: 9, title: 'Experiment with Vue transition for subtle animations.', deadline: '2024-02-26' },
  { id: 10, title: 'Integrate local storage for persistent task data.', deadline: '2024-06-10' },
  {
    id: 11,
...
watch(selectedOption, (newOption) => {
  sortedTask.value = sortTasksByOption(tasks, newOption)
})
</script>
